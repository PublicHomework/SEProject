...
export default defineComponent({
    setup() {      
        ...
        return { gameConfig, navigation, username, hideModal, botsList, submitBotSelection, updateSubmitFileList, botFileList, submitBotFileSelection, submissions, onChangeSelection, selectedNum, submitBot, startChallenge }
    },
})
</script>
